...
//	  
//	  @MockBean private CourseServiceImpl courseServiceImpl;
//	  
////	  @Test public void TestregisterCourse() throws Exception { CourseDTO
////	  course_dto=new CourseDTO();
////	  
////	  course_dto.setStudentId(new Long(1)); course_dto.setCourseCode("4");
////	  course_dto.setCourseDuration("Strin");
